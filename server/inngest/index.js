    ...
    async ({ event, strp }) => {
        ...
        await sendEmail({
            ...
            body: `<div style="max-width: 600px;">
                        ...
                        <p style="margin-top: 20px; font-size: 14px; color: #6c757d;">Please make sure to review and complete it before the duedate.</p>
                    </div>
                    `
        })

        if(new Date(task.due_date).toLocaleDateString() !== new Date().DateString()){
                    ...
                    await step.run('send-task-reminder-mail', async () => {
                        await sendEmail({
                            ...
                            <div style="max-width: 600px;">
                                ...
                                <a href="${origin}" style="background-color:#007bff; padding: 12px 24px; border-radius:5px; color: #fff; font-weight: 600; font-size:16px; text-decoration: none;">View Task</a>
                                <p style"margin-top: 20px; font-size: 14px;color: #6c757d;">Please make sure to review and complete itbefore the due date.</p></div>'
                            </div>
                            `
                        })
                    })
